...
Greetings! - HUGO
https://discourse.gohugo.io/t/greetings/27643

Understanding Discourse Trust Levels
https://blog.discourse.org/2018/06/understanding-discourse-trust-levels/

long-hugo-doc/README.md at master � hamoid/long-hugo-doc
https://github.com/hamoid/long-hugo-doc/blob/master/README.md
...
(3) Block in a partial and defining in a page - support - HUGO
https://discourse.gohugo.io/t/block-in-a-partial-and-defining-in-a-page/4999/4

(3) Partials based on content format - support - HUGO
https://discourse.gohugo.io/t/partials-based-on-content-format/28195

Add closing partials � Issue #3929 � gohugoio/hugo
https://github.com/gohugoio/hugo/issues/3929

(3) Block in a partial and defining in a page - support - HUGO
https://discourse.gohugo.io/t/block-in-a-partial-and-defining-in-a-page/4999

Add closing partials � Issue #3929 � gohugoio/hugo
https://github.com/gohugoio/hugo/issues/3929

Error using first: both limit and seq must be provided - support - HUGO
https://discourse.gohugo.io/t/error-using-first-both-limit-and-seq-must-be-provided/11704/2
...
(3) Get extension of file name? - support - HUGO
https://discourse.gohugo.io/t/get-extension-of-file-name/1667/5

## conditionals

Hugo's cond template function explained � Kodify
https://kodify.net/hugo/functions/hugo-cond-function/

(3) Conditional shortcode with index - issue when no params are passed - support - HUGO
https://discourse.gohugo.io/t/conditional-shortcode-with-index-issue-when-no-params-are-passed/10608/5
...
(3) MIME type ('text/plain') is not a supported stylesheet MIME type, and strict MIME checking is enabled - support - HUGO
https://discourse.gohugo.io/t/mime-type-text-plain-is-not-a-supported-stylesheet-mime-type-and-strict-mime-checking-is-enabled/16435/20
...
plopcas/papaya: Minimalist Hugo theme with social buttons and analytics.
...
A Beginner?s Guide to Creating a Static Website with Hugo - Reader
...
frankieliu/hugo-lithium: Lithium - A simple responsive Hugo theme
https://github.com/frankieliu/hugo-lithium

About - Yihui Xie | ???
https://yihui.org/en/about/

bookdown/inst/examples at master � rstudio/bookdown
https://github.com/rstudio/bookdown/tree/master/inst/examples

Github Issue Guide - Yihui Xie | ???
https://yihui.org/issue/

r markdown - `bookdown site` generation via `blogdown` - Stack Overflow
https://stackoverflow.com/questions/63905506/bookdown-site-generation-via-blogdown

r - Will `_bookdown.yml` work in `blogdown` the same as `bookdown`? - Stack Overflow
https://stackoverflow.com/questions/49170452/will-bookdown-yml-work-in-blogdown-the-same-as-bookdown

hugo - Change figure and table captions in blogdown - Stack Overflow
https://stackoverflow.com/questions/49440295/change-figure-and-table-captions-in-blogdown/49736062#49736062

GitBook - Document Everything!
https://www.gitbook.com/

6.2 GitHub | bookdown: Authoring Books and Technical Documents with R Markdown
